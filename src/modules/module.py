...
from src.models.hf_seg_wrapper import get_hf_model  
import wandb
...
class Module(pl.LightningModule):
    def __init__(self,cfg):
        ...
        self.cyclegan.to("cuda")
        self.segmentation.to("cuda")
    ...
    def forward(self, drrs, xrays):
        ...
        model_dtype = next(self.segmentation.parameters()).dtype
    ...
    def training_step(self, batch, batch_idx):
        ...
        upsampled_logits = F.interpolate(
            ...
            mode='bilinear', # Bilinear interpolation is standard for logits
            align_corners=False
        )
    ...
    def validation_step(self, batch, batch_idx):
        ...
        # Optionally: log images for monitoring GAN output
        if batch_idx == 100:
            grid = torch.cat([drrs[:4], fake_img[:4]], dim=-1)  # simple side-by-side visualization
